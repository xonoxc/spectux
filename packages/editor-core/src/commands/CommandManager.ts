...
export interface CommandManager {
   execute: (
      command: Command,
      project: Project
   ) => Result<{ project: Project; event: ReturnType<Command["emitEvent"]> }, EditorError>
   undo: (project: Project) => Result<{ project: Project; command: Command } | null, EditorError>
   redo: (project: Project) => Result<{ project: Project; command: Command } | null, EditorError>
   canUndo: () => boolean
   canRedo: () => boolean
   clear: () => void
