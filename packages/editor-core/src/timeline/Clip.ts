...
export function moveClip(clip: Clip, newTimelineStart: number): Result<Clip, EditorError> {
...
export function trimClip(clip: Clip, newStart: number, newEnd: number): Result<Clip, EditorError> {
...
export function splitClipAt(clip: Clip, splitTime: number): Result<[Clip, Clip], EditorError> {
