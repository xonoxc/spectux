...
export function createTrimClipCommand(payload: TrimClipCommandPayload): Command {
   ...
   return {
      ...
      execute(project: Project): Result<Project, EditorError> {
         ...
         return trimClipOperation(project, payload.clipId, payload.newStart, payload.newEnd)
      },
